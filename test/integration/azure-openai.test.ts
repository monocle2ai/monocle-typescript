...
describe('Azure OpenAI Sample', () => {
    ...
    it('should generate all expected spans', async () => {
        ...
        const ndjsonPath = join(__dirname, '../examples/azureOpenaiChatCompletion.ndjson');
        ...
        // Run the sample code
        await (await import('../examples/azureOpenaiChatCompletion')).main();
