...
describe('LlamaIndex Agent Sample', () => {
    ...
    it('should generate all expected spans', async () => {
        ...
        const ndjsonPath = join(__dirname, '../examples/llamaIndexAgentSampleChat.ndjson');
        ...
        // Run the sample code
        await (await import('../examples/llamaIndexAgentSampleChat.js')).main();
